                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle" style="width: 150px; height: 150px; object-fit: cover; border: 3px solid #adb5bd;" src="{{ url('/admin/file/FILE_PHOTOPROFILE/' . photo_profile()) }}" alt="User profile picture" onerror="this.onerror=null;this.src='{{ asset('public/assets/img/user.png') }}';">
                            </div>
