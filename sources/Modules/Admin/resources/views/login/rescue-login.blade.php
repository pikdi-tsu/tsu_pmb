        ...
        <div class="card card-outline card-danger">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('rescue.post') }}" method="POST" onsubmit="freezeRescueButton()">
                    @csrf
                    {{-- INPUT 1: USERNAME / NIK --}}
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Target NIK / Username" name="username" value="{{ old('username') }}" required autofocus>
                ...
                <div class="mt-3 text-center">
                    <a href="{{ route('loginadmin') }}" class="text-sm text-muted">Kembali ke Login Normal</a>
                </div>
